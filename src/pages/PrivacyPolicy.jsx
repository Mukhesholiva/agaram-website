...
export default function PrivacyPolicy() {
  useEffect(() => {
    document.title = 'Privacy Policy | Venkata Sivaji Charitable Foundation';
  }, []);
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        >
          ...
          <div className="relative flex w-full p-3 flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased space-y-6 text-gray-700 text-base leading-relaxed">
            <p>Venkata Sivaji Charitable Foundation takes your privacy seriously and treats all financial information about any transaction you have with the Foundation as highly confidential.</p>
            <p>In addition, Venkata Sivaji Charitable Foundation does not share e-mail addresses or phone numbers of any of our donors or constituents. The Foundation deeply values all contributions to sustain our mission.</p>
            <p>To protect the privacy of our donors and their special relationship with Venkata Sivaji Charitable Foundation, we maintain the following policies:</p>
            <ul className="list-disc list-inside space-y-2 pl-2">
              <li>We may request personal information online, such as name, address, phone number, email address, and account details for the purposes of accepting donations to Venkata Sivaji Charitable Foundation.</li>
              ...
              <li>Personal information stored in Venkata Sivaji Charitable Foundation's database is protected with a secured login with authentication, assignment of a unique ID to each person with computer access and user IDs are deactivated or terminated as needed.</li>
            </ul>
            ...
            <p>Venkata Sivaji Charitable Foundation doesn't encourage refund or cancellation of funds.</p>
            <p>
