                  ...
                  <div className="relative flex w-full flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased p-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <address className="not-italic text-gray-600 leading-relaxed">1-9, Mukthinuthalapadu,<br />Ongole, Prakasam District,<br />Andhra Pradesh - 523262</address>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="relative flex w-full flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <a href="tel:+918096112016" className="text-green-600 hover:text-green-800 transition-colors duration-200 text-lg block">+91 80961 12016</a>
              ...
              <div className="flex flex-col relative overflow-hidden h-auto text-foreground box-border bg-content1 outline-solid outline-transparent data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 rounded-large transition-transform-background motion-reduce:transition-none shadow-lg mx-auto max-w-lg" tabIndex={-1}>
                <div className="relative flex w-full flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased p-8">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <a className="relative tap-highlight-transparent outline-solid outline-transparent data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-primary no-underline hover:opacity-hover active:opacity-disabled flex flex-col items-center p-4 rounded-lg hover:bg-green-50 transition-colors duration-200 group" href="https://wa.me/918096112016" target="_blank" rel="noopener noreferrer" tabIndex={0} data-react-aria-pressable="true" role="link">
